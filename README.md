...
| [El instalador falso del "trabajo de scripter"](fundamentos/Instalador_Falso_Roblox.md) | Caso real analizado sin ejecutarlo: cómo reconocer un dropper empaquetado, cómo comprobar tu equipo y qué hacer si cayó. Incluye [`revisar_pc.ps1`](fundamentos/revisar_pc.ps1) para detectar y [`limpiar_pc.ps1`](fundamentos/limpiar_pc.ps1) para remediar |
